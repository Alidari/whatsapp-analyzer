        ...
        <defs>
          {pathData.map((_, i) => (
            <linearGradient
              ...
              x2="100%"
              y2="100%">
              <stop offset="0%" stopColor="#59dcb5" stopOpacity="0" />
              <stop offset="20%" stopColor="#59dcb5" stopOpacity="1" />
              <stop offset="50%" stopColor="#bbc3ff" stopOpacity="1" />
              <stop offset="80%" stopColor="#f8acff" stopOpacity="1" />
              <stop offset="100%" stopColor="#f8acff" stopOpacity="0" />
            </linearGradient>
          ))}
        </defs>
      </svg>
